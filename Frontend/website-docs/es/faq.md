...
- Necesitas instalar nuestro certificado HTTPS. Descarga [nuestro switcher de servidor](/static/switcher) y haz clic en **"Install certificate"**. Si sigues teniendo problemas, [sigue estas instrucciones](https://redstar.moe/index.php?p=16&id=12) para instalar el certificado **manualmente**.
...
- **Obtengo "Invalid Redstar IP" en el switcher, ¿cómo puedo arreglarlo?**
- Asegúrate de que la IP de Redstar no tenga caracteres no válidos (como espacios, comas, etc.) La IP debe contener sólo números y puntos.
...
- Asegúrate de que estés usando la última versión del switcher. Debería ser similar a [esto](https://b.catgirlsare.sexy/xqJw.png). Si se ve diferente, descárgalo de nuevo de [aquí](/static/switcher)
...
- **Mi switcher está en off pero cuando abro osu.ppy.sh en mi navegador ¡me redirige al sitio web de Redstar!**
...
- **Obtengo errores extraños en el sitio web de osu! después de jugar en Redstar (mapas no encontrados, etc.)**
...
- **¿Hay un parche para Redstar?**
- No, puedes cambiar de servidor editando el archivo de hosts con nuestro switcher. [Instrucciones aquí](https://redstar.moe/doc/1).

-----------------------

- **¿Puedo tener el código fuente de Redstar?**
-  Redstar es completamente de código abierto, puedes verlo [aquí](https://github.com/osuRedstar/Redstar-windows).

-----------------------

- **¿Por qué osu!direct y otros beneficios para los apoyan el juego son gratis?**
- Pensamos que osu!direct es genial y es una pena que la gente tenga que pagar por tenerlo, por eso lo ofrecemos gratis en Redstar. Si te gusta lo que hacemos, por favor considera una [donación](/donate)

-----------------------

- **Mi problema no está enlistado aquí**
- Únete a nuestro [Discord](https://discord.redstar.moe) y haz tu pregunta en el canal #help del servidor.