...
class personalBestCacheAP:
	def get(self, userID, fileMd5, country=False, friends=False, mods=-1):
		...
		try:
			...
			data = glob.redis.get("lets:personal_best_cache_ap:{}".format(userID))
			if data is None:
				raise cacheMiss()
	...
	def set(self, userID, rank, fileMd5, country=False, friends=False, mods=-1):
		...
		:return:
		"""
		glob.redis.set("lets:personal_best_cache_ap:{}".format(userID), "{}|{}|{}|{}|{}".format(rank, fileMd5, country, friends, mods), 1800)
