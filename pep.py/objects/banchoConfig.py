...
class banchoConfig:
	...
	def loadSettings(self):
		...
		if mainMenuIcon is None:
			...
			#imageURL = "https://redstar.moe/static/logos/main_menu_icons.png".format(mainMenuIcon["file_id"])
			imageURL = glob.db.fetch("SELECT value_string FROM bancho_settings WHERE name = 'menu_icon'")
			imageURL = imageURL["value_string"].format(mainMenuIcon["file_id"])
