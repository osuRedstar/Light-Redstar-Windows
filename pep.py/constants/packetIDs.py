...
client_unknownPacket = -1  # unmapped
...
server_pong = 8
server_handleIrcChangeUsername = 9  # unused
...
client_joinMatch = 32
client_partMatch = 33
server_toggleBlockNonFriendDms = 34 #client 99 중복
35 #?
...
server_monitor = 80  # unused
server_matchPlayerSkipped = 81
client_setAwayMessage = 82
server_userPresence = 83 #server_userPanel = 83
client_ircOnly = 84
client_userStatsRequest = 85
server_restart = 86
client_matchInvite = 87
server_matchInvite = 88
...
client_userPresenceRequest = 97 #client_userPanelRequest = 97
client_userPresenceRequestAll = 98
client_toggleBlockNonFriendDms = 99 #server 34 중복
server_userDmBlocked = 100
server_targetIsSilenced = 101
server_versionUpdateForced = 102
server_switchServer = 103
server_accountRestricted = 104
server_rtx = 105  # unused
server_matchAbort = 106
server_switchTournamentServer = 107 #server_switchServer = 107
